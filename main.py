...
inp = "C:/Users/polii/Documents/pistepilvi/data/"
#inp = "" # write your own file path here
dataname = "radar_pointcloud_1.bin"

# Loads a point cloud from a binary file and returns it as a o3d point cloud object
...
def animation(type="combined_mesh", start_index=1, stop_index=20):
    ...
    for i in range(start_index, stop_index+1):
        ...
        # remove all the former pcd/mesh from the visualizer
...
## Functions related to pointcloud merging ##
...
def load_point_clouds(num_of_pcs, index, down_sample=False):
    pcds = []
    x = range(index, index+num_of_pcs)
    for i in x:
        dname = "radar_pointcloud_" + str(i) + ".bin"
...
## uncomment wanted function calls
